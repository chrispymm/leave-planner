class PeopleController < ApplicationController
  ...
  def new
    @person = Current.account.people.new(
      allowance_unit: "days",
  ...
  def create
    @person = Current.account.people.new(person_params)
    if @person.save
  ...
  def set_person
    @person = Current.account.people.find(params[:id])
  end
  ...
  def sample_color
    ...
    used = Current.account.people.pluck(:color)
